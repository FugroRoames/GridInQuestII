...
{ Grid InQuest II BNG Updater Utility Program.
...
Uses
  Classes, SysUtils, CustApp, DOS, IOMain, GeodProc;
...
Begin
  If SilentMode Then
    Exit;
  WriteLn('BNGUpdate - GridInQuestII BNG OSTN02 to OSTN15 updater utility.');
